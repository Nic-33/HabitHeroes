        ...
        <div className="landing-page-ctn">
            ...
            <div className='landing-sec-2'>
                <div className='sec2MainCont'>
                    ...
                    <p className="ct">Habit Heroes is a free habit-building and productivity app that treats your real life like a game. With in-game rewards and punishments to motivate you and a strong social network to inspire you, Habit Heroes can help you achieve your goals to become healthy, hard-working, and happy.</p>
                </div>
                <div className='hilight-ctn'>
                    <div className='landing-hilight'>
                        ...
                        <div>
                            ...
                            <p className="ct">Stay accountable by tracking and managing your Habits, Daily goals, and To Do list with Habit Heroes’s easy-to-use mobile apps and web interface.</p>
                        </div>
                    </div>
            ...
            <div className='landing-sec-3'>
                <h2 className="ct">Players Use Habit Heroes to Improve</h2>
                ...
                <div className='hilight-ctn'>
                    <div className='landing-hilight'>
                        ...
                        <div>
                            ...
                            <p className="ct">Never motivated to floss? Can't seem to get to the gym? Habit Heroes finally makes it fun to get healthy.</p>
                        </div>
                    </div>
                    ...
                    <div className='landing-hilight'>
                        ...
                        <div>
                            ...
                            <p className="ct">Our fully customizable task list means that you can shape Habit Heroes to fit your personal goals. Work on creative projects, emphasize self-care, or pursue a different dream -- it's all up to you.</p>
                        </div>
                    </div>
                </div>
            </div>
